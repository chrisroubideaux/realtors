  ...
  return (
    <ul className="list-group w-100 pt-2 pb-4 m-4">
      ...
      <h5 className="mb-0 p-3 pb-1 fw-bold">
        ...
        {condos.bathrooms} bath
      </h5>
      <h5 className="mb-0 p-3 pb-1 fw-bold">
        <i className=" card-icons fa-solid fa-ruler me-2"></i>
        Floor plan: {condos.Flooring}
      </h5>
      <h5 className="mb-0 p-3 pb-1 fw-bold">
